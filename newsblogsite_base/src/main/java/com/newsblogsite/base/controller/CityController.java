...
import com.newsblogsite.base.service.CityService;
...
public class CityController {
	...
	/**
	 * 分页+多条件查询
	 * @param searchCity 查询条件封装
	 * @param page 页码
	 * @param size 页大小
	 * @return 分页结果
	 */
	@RequestMapping(value="/search/{page}/{size}",method=RequestMethod.POST)
	public Result findSearch(@RequestBody City searchCity , @PathVariable int page, @PathVariable int size){
		Page<City> pageList = cityService.findSearch(searchCity, page, size);
    ...
    public Result findSearch( @RequestBody City searchCity){
        return new Result(true,StatusCode.OK,"查询成功",cityService.findSearch(searchCity));
    }
